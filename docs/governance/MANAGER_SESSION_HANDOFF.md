...
_Current snapshot: 2026-07-26. Fetch `origin` before relying on any recorded
...
| PS-OPS-001 | **Candidate `Pass`; production Gate F authorized.** Exact Azure build 256 at `1ca3ea6120fc8fcbfeba30137a3bfc94d5508772` passed artifact, scanner, test, isolated deployment, live identity/route smoke, and stop controls; Pete separately approved `Pass` on 2026-07-27 | Complete the required Azure PR, main Build/Deploy/ProductionSmoke, exact live verification, and temporary Candidate-plan cleanup; do not claim release before that evidence |
