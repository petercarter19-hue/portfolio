...
| Retired | Deliberately removed; compatibility redirects may remain |
...
| PS-FEAT-002 | Colorful Community corkboard | Retired | — | None | Do not restore; use the canonical Community Feed and its future protected data service | `PS-FEAT-002_People_Interests_Feed.md` |
