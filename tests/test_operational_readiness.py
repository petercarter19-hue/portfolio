...
class ProfessionalReadinessGovernanceTests(unittest.TestCase):
    ...
    def test_current_pointer_lineage_and_ps_ops_authority_are_reconciled(self):
        ...
        self.assertIn(
            'deployed_main_commit: "05f0c228404655d63d5c1ddbbc0a3c2d1d54491e"',
            baseline,
        )
        self.assertIn('deployed_pipeline: 388', baseline)
        ...
        self.assertIn(
            'application_behavior_commit: "05f0c228404655d63d5c1ddbbc0a3c2d1d54491e"',
            baseline,
        )
